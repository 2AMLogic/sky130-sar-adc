...
- ~~**On-die decoupling** for either domain is not designed, budgeted, or
  ...
  [DR-016](DR-016-on-die-decoupling-budget.md) (issue #431): one
  ...
  because DR-016's own measurements show the die-side excursion falls only as
  ...
  DR-016 is a decoupling decision, not an IR-drop analysis, and `klt power` has
