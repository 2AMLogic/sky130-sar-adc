...
[`layout/sampling-frontend/reports/20260918-191227-935ce76/record.md`](../../layout/sampling-frontend/reports/20260918-191227-935ce76/record.md)
(current `reports/LATEST`, issue #326's minimum-area rebuild; supersedes
...
> **match** with **2** mismatches and **0** errors; devices **1060** layout /
> **1060** reference / **1060** matched; nets **42** / **42** / **42**
> matched; pins **24** / **24** / **24** matched; by category
> `device.body_unverified: 1`, `topology: 1`.
...
> status **match** with **2** mismatches and **0** errors; devices **24**
> layout / **24** reference / **24** matched; nets **17** / **17** / **17**
> matched; pins **12** / **12** / **12** matched; by category
> `device.body_unverified: 1`, `topology: 1`.
...
> `layout/sampling-frontend/`, newest `20260918-191227-935ce76`, while
> `reports/LATEST` there names `20260918-191227-935ce76`: **current**.
> - the composition on `layout/sar-adc-top/reports/LATEST` embeds a
...
- **`klt erc` (power delivery, structural)**: **all four declared supplies
  ...
  **layout** (the supply spec's content hash is byte-identical across the two
  ...
  ([`erc-reports/20260924-190825-f3622fc/record.md`](../../layout/sar-adc-top/erc-reports/20260924-190825-f3622fc/record.md))
...
and on 2026-09-24 by issue #355's digital supply-rail tie,
[`layout/sar-adc-top/reports/20260924-190817-f3622fc/record.md`](../../layout/sar-adc-top/reports/20260924-190817-f3622fc/record.md),
...
examples below included): of the **25** "current `…/LATEST`" phrases in this
document, **13** are attached and therefore checked; of the **12** skipped,
...
> **411** matched; pins **21** / **21** / **21** matched; by category
...
1. **Top-level layout exists but is neither LVS-clean nor post-layout
   ...
   **any post-layout PVT re-simulation** of the assembled top level (none has
   ...
   [`layout/sampling-frontend/reports/20260918-191227-935ce76/record.md`](../../layout/sampling-frontend/reports/20260918-191227-935ce76/record.md),
   current `reports/LATEST` — issue #326's minimum-area rebuild, at a
   field-identical DRC/LVS verdict to the `20260915-120718-1e90b14/` it
   supersedes; see this item's citation-freshness corrections below for why
   ...
   **Update (2026-09-24): the release gate cleared, the LVS mismatch did
   ...
   - The `--abstract-cells` collapse this item's earlier updates measured
     ...
     [`layout/sar-adc-top/reports/20260924-190817-f3622fc/record.md`](../../layout/sar-adc-top/reports/20260924-190817-f3622fc/record.md),
     the current `reports/LATEST` (superseding `20260923-131726-fa1e0af`,
     which superseded `20260919-050355-fb11617`, this item's prior citations).
...
9. **Power delivery is now structurally graded — the two digital rails failed
   ...
   **Issue #355 (2026-09-24) fixed it, in the layout and not in the gate.**
   ...
   [`layout/sar-adc-top/erc-reports/20260924-190825-f3622fc/record.md`](../../layout/sar-adc-top/erc-reports/20260924-190825-f3622fc/record.md),
   reports `erc_status: clean`, **0** findings:

   | Supply | Islands, 2026-09-23 | Islands, now | Continuity verdict |
   |---|---:|---:|---|
   | `VDD` | 1 | 1 | pass |
   | `GND` | 1 | 1 | pass, **read narrowly** — see below |
   | `VPWR` | 2 | **1** | pass |
   | `VGND` | 2 | **1** | pass |
   ...
   **Item 11 is nevertheless still UNMET**, and this document does not round
   ...
   - **The ERC record is no longer a revision behind** — that qualification,
     ...
     (`sha256:543efabf…`, hash-asserted at run time), which is exactly what
     ...
     verdict beside it.
   - **"One island" is not "reaches a pad".** `klt erc` grades continuity, not
     whether a continuous net terminates anywhere a package could bond to.
     `GND` passes and has no top-level pin at all (`.GLOBAL GND`, absent from
     the netlist's own port list); the digital rails now do have one, which is
     what #355 added. Tracked as issue **#362**.
   ...
   **Does this move any §4 row? Not in verdict, but two rows' numbers move.**
   ...
   row's readout — 21/21/21 pins and 88 mismatches, from 19/19/19 and 98 —
   because two new top-level supply pins are two new top-level pins, and §2.2's
   pad table carries them too. And what the 2026-09-23 pass wrote here still
