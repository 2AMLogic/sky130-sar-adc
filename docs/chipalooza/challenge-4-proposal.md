...
2. **Sample rate is not re-derived (narrowed this pass, not closed).**
   ...
   **Update this pass (2026-09-26) — "all four PVT-complete" is qualified,
   ...
   top-plate load, and the two campaigns that do carry the full load were
   cited nowhere in this document.** Nothing is re-measured here and no
   ...
   *The two campaigns that do carry it, and what they report.* Exactly two
   runs in this tree load the combined pair, and neither was cited anywhere
   in this document before this pass:
   ...
   the combined case very plausibly clears too. Nothing in this tree says
   whether it does.
