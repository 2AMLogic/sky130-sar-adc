...
> table, **15** name a flow that publishes a `LATEST` pointer and are
...
examples below included): of the **26** "current `…/LATEST`" phrases in this
document, **14** are attached and therefore checked; of the **12** skipped,
