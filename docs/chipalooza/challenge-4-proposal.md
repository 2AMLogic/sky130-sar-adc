...
4. **ENOB / INL-DNL target values are proposed, not ratified.**
   ...
   **Update this pass (2026-09-18): this item's status claim is now
   ...
   > is **proposed**.
   > **DR-015** (`spec/decision-records/DR-015-testbench-package-model.md`) is
   > **proposed**.
