...
| Sample rate | DRAFT | UNMEASURED as an end-to-end sample-rate figure (four mechanisms probed individually, not combined);… | 8 record(s), see detail below |
...
| Power | DRAFT | UNMEASURED as a Power-row figure/target (informational first current/power evidence only, not a pas… | 1 record(s), see detail below |
