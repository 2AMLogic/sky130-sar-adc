...
| Sample rate | DRAFT | UNMEASURED as an end-to-end sample-rate figure (four mechanisms probed individually, not combined);… | 4 record(s), see detail below |
