...
- **Tracking**: DR-014 (#349: static preamp not adopted, DR-004 Decision 1 stands, no mitigation adopted yet); #390 (common-mode/differential split of the kickback measurement, DR-014's first gate -- DELIVERED by the record below, which supersedes #346's baseline; what remains open on this track is DR-014 Consequences §4's disposition, i.e. measuring the headroom-neutral mitigation classes it names); DR-011's Open items (a budget-derived successor bound, a residual-at-next-decision measurable, and the full-corner kickback campaign ratification would require)
