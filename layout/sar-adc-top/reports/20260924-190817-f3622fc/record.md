# SAR ADC top-level assembly record: 20260924-190817-f3622fc

## Provenance
- `klt` version: klt 0.6.0
- PDK variant: sky130A
- repo commit: `f3622fc3beabc31f0607ca949a0c33c57f1f089c` (dirty)
...
- verdict: **mismatch**
- pins promoted from `--pin-source-cells`: layout=21 reference=21 matched=21 (expected 19/19/19) -- klayout-tools#1513 is resolved: this is the first record where every top-level pin promotes correctly.
