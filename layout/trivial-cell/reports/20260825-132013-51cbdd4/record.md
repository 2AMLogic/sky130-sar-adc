# Layout DRC/LVS record: 20260825-132013-51cbdd4
...
| LVS negative control: device parameter | mismatch | mismatch_count=49, category_counts={'device.body_unverified': 1, 'device.unmatched': 8, 'net.unmatched': 38, 'topology': 2} |
| LVS negative control: topology (shorted net) | mismatch | mismatch_count=48, category_counts={'device.body_unverified': 1, 'device.unmatched': 8, 'net.unmatched': 37, 'topology': 2} |
...
- Record ID: `20260825-132013-51cbdd4`
...
- Repo state: `51cbdd44f00b8232744c8a8acc50fb269c0969af` on `feature/issue-100` (dirty)
