...
from _pfet_devices import DOMAIN_TAP_NET, PFET_DEVICES as DEVICES  # noqa: E402,F401
...
def main() -> int:
    ...
    for block_id, schematic_name, _domain, w_um, l_um, *_nets in DEVICES:
        ...
        stdout, stderr = run_gen(
            args.klt, args.pdk, "mos_array", block_params(w_um, l_um), schematic_name.upper(), gds_path
        )
